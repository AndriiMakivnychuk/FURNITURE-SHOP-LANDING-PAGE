(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".slider-rooms__boby")) new core(".slider-rooms__boby", {
            modules: [ Navigation, Pagination, EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (window.innerWidth > 768 && isMobile.any()) {
                ...
                if (!targetElement.closest(".menu__item") && document.querySelectorAll(".menu__item._hover").length > 0) document.querySelectorAll(".menu__item._hover").forEach((menuItem => {
